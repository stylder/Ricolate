    ...
    <nav class="navbar navbar-fixed-top navbar-inverse">
        <div class="container">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/admin"><strong><span class="white">Ricolate</span></strong></a>
            </div>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown {{ ( Route::getCurrentRoute()->getPath() === 'admin/products' || Route::getCurrentRoute()->getPath() === 'admin/products/create' ) ? 'active' : NULL }}">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="/admin/products">Editar Productos</a></li>
                            <li><a href="/admin/products/create">Agregar Productos</a></li>
                        </ul>
                    </li>
                    <li class="dropdown {{ ( Route::getCurrentRoute()->getPath() === 'admin/slideshow' || Route::getCurrentRoute()->getPath() === 'admin/slideshow/create' ) ? 'active' : NULL }}">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="/admin/slideshow">Editar Slideshow</a></li>
                            <li><a href="/admin/slideshow/create">Agregar Slideshow</a></li>
                        </ul>
                    </li>
                    <li class="dropdown {{ ( Route::getCurrentRoute()->getPath() === 'admin/users' || Route::getCurrentRoute()->getPath() === 'admin/register' ) ? 'active' : NULL }}">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li><a href="/admin/register">Agregar Usuarios</a></li>
                        </ul>
                    </li>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <p class="text-muted text-center"><strong><span class="white">Ricolate</span></strong><br />
                        Copyright 2017 <a href="http://justinc.me" target="_BLANK"></a></p>
                </div>
            </div>
        </div>
    </footer>
