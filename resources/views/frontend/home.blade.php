...
@section('content')
            ...
            <ul>
                ...
                @empty
                        <li class="revolution-mch-1" data-transition="fade" data-slotamount="5" data-masterspeed="1000"
                            data-title="Slide 1">
                            <!-- MAIN IMAGE -->
                            <img src="{{ $slide->image_path }}" alt="darkblurbg" data-bgfit="cover"
                            ...
                            <div class="tp-caption sft"
                                 ...
                                 data-captionhidden="off"
                                 style="z-index: 6">
                                <a href="{{ $slide->href }}" class="btn-u btn-brd btn-brd-hover btn-u-light">Shop Now</a>
                            </div>
                        </li>
            @endforelse
            <!-- SLIDE -->
    ...
    <div class="fb-page" data-href="https://www.facebook.com/Ricolate.Insumos/" data-tabs="timeline" data-small-header="false" data-adapt-container-width="true" data-hide-cover="false" data-show-facepile="true"><blockquote cite="https://www.facebook.com/Ricolate.Insumos/" class="fb-xfbml-parse-ignore"><a href="https://www.facebook.com/Ricolate.Insumos/">Ricolate</a></blockquote></div>
